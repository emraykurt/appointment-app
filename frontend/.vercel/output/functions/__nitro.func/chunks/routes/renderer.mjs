...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Basit randevu sistemi uygulaması"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Randevu Sistemi"};
